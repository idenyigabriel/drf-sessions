"""
Unit tests for drf-sessions SessionService.
"""
...
class SessionServiceTests(TestCase):
    def setUp(self):
        ...
        self.issued = SessionService.create_session(self.user)
    ...
    def test_create_helpers_set_correct_transport(self):
        ...
        cookie_session = SessionService.create_cookie_session(self.user).session
        header_session = SessionService.create_header_session(self.user).session
    ...
    def test_refresh_token_success(self):
        ...
        new_issued = SessionService.refresh_token(self.raw_refresh)
    ...
    def test_reuse_detection_revokes_session(self):
        ...
        SessionService.refresh_token(self.raw_refresh)

        # Attempt to use the SAME token again (Reuse/Attack)
        result = SessionService.refresh_token(self.raw_refresh)
    ...
    def test_fails_for_expired_token(self):
