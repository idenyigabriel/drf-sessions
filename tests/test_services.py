...
class SessionServiceTests(TestCase):
    def setUp(self):
        ...
        self.issued = SessionService.create_universal_session(self.user)
    ...
    def test_rotate_refresh_token_success(self):
        ...
        new_issued = SessionService.rotate_refresh_token(self.raw_refresh)
    ...
    def test_reuse_detection_revokes_session(self):
        ...
        SessionService.rotate_refresh_token(self.raw_refresh)
